# Eco World — Phase 3 Production Checklist
...
```
python pipeline.py --project ecoWorld --phase 3 --topic "Your Topic" --outline "Your outline" --duration 12
```
...
```
python tools/compliance_checker.py --project ecoWorld --phase 3
```
...
## Step 4 — Voiceover
```
python tools/tts/kokoro_voiceover.py --phase 3 --project ecoWorld
```
- [ ] `voiceover/phase_3.wav` exists
...
```
python tools/platform_cutter.py --project ecoWorld --phase 3 --video _output/phase_03/final.mp4
```
- [ ] `_output/phase_03/youtube/final_1080p.mp4`
- [ ] `_output/phase_03/tiktok/clip_01_hook.mp4`
- [ ] `_output/phase_03/instagram/reel_60s.mp4`
- [ ] `_output/phase_03/twitter/card_clip.mp4`

## Step 7 — Text Content
```
python tools/text_content_generator.py --project ecoWorld --phase 3
```
- [ ] `_output/phase_03/youtube/description.txt`
- [ ] `_output/phase_03/twitter/thread.txt`
- [ ] `_output/phase_03/linkedin/article.md`
- [ ] `_output/phase_03/blog/post.md`
...
---
*Bhrikuty Film Director — Phase 3 of 5*
