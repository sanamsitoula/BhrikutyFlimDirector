# Eco World — Phase 5 Production Checklist
...
```
python pipeline.py --project ecoWorld --phase 5 --topic "Your Topic" --outline "Your outline" --duration 12
```
...
```
python tools/compliance_checker.py --project ecoWorld --phase 5
```
...
## Step 4 — Voiceover
```
python tools/tts/kokoro_voiceover.py --phase 5 --project ecoWorld
```
- [ ] `voiceover/phase_5.wav` exists
...
```
python tools/platform_cutter.py --project ecoWorld --phase 5 --video _output/phase_05/final.mp4
```
- [ ] `_output/phase_05/youtube/final_1080p.mp4`
- [ ] `_output/phase_05/tiktok/clip_01_hook.mp4`
- [ ] `_output/phase_05/instagram/reel_60s.mp4`
- [ ] `_output/phase_05/twitter/card_clip.mp4`

## Step 7 — Text Content
```
python tools/text_content_generator.py --project ecoWorld --phase 5
```
- [ ] `_output/phase_05/youtube/description.txt`
- [ ] `_output/phase_05/twitter/thread.txt`
- [ ] `_output/phase_05/linkedin/article.md`
- [ ] `_output/phase_05/blog/post.md`
...
---
*Bhrikuty Film Director — Phase 5 of 5*
