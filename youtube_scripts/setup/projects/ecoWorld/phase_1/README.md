# Eco World — Phase 1 Production Checklist
...
```
python pipeline.py --project ecoWorld --phase 1 --topic "Your Topic" --outline "Your outline" --duration 12
```
...
```
python tools/platform_cutter.py --project ecoWorld --phase 1 --video _output/phase_01/final.mp4
```
- [ ] `_output/phase_01/youtube/final_1080p.mp4`
- [ ] `_output/phase_01/tiktok/clip_01_hook.mp4`
- [ ] `_output/phase_01/instagram/reel_60s.mp4`
- [ ] `_output/phase_01/twitter/card_clip.mp4`

## Step 7 — Text Content
```
python tools/text_content_generator.py --project ecoWorld --phase 1
```
- [ ] `_output/phase_01/youtube/description.txt`
- [ ] `_output/phase_01/twitter/thread.txt`
- [ ] `_output/phase_01/linkedin/article.md`
- [ ] `_output/phase_01/blog/post.md`
...
---
*Bhrikuty Film Director — Phase 1 of 5*
