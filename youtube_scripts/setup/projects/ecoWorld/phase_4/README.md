# Eco World — Phase 4 Production Checklist
...
```
python pipeline.py --project ecoWorld --phase 4 --topic "Your Topic" --outline "Your outline" --duration 12
```
...
```
python tools/compliance_checker.py --project ecoWorld --phase 4
```
...
## Step 4 — Voiceover
```
python tools/tts/kokoro_voiceover.py --phase 4 --project ecoWorld
```
- [ ] `voiceover/phase_4.wav` exists
...
```
python tools/platform_cutter.py --project ecoWorld --phase 4 --video _output/phase_04/final.mp4
```
- [ ] `_output/phase_04/youtube/final_1080p.mp4`
- [ ] `_output/phase_04/tiktok/clip_01_hook.mp4`
- [ ] `_output/phase_04/instagram/reel_60s.mp4`
- [ ] `_output/phase_04/twitter/card_clip.mp4`

## Step 7 — Text Content
```
python tools/text_content_generator.py --project ecoWorld --phase 4
```
- [ ] `_output/phase_04/youtube/description.txt`
- [ ] `_output/phase_04/twitter/thread.txt`
- [ ] `_output/phase_04/linkedin/article.md`
- [ ] `_output/phase_04/blog/post.md`
...
---
*Bhrikuty Film Director — Phase 4 of 5*
